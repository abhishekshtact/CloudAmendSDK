...
-(void)loadImageBasedOnCondition{
    ...
    if(fieldCount==0){
        ...
        if([rowValue isEqualToString:@"insertimage"]){
            [cloudAmend insertImage:self.etFirstOutlet.text];
        }
        else if ([self.lbfirstOutlet.text isEqualToString:@"Width"])
        {
            ...
            [cloudAmend transformWidth:[self.etFirstOutlet.text intValue]];
        ...
        else if([self.lbfirstOutlet.text isEqualToString:@"Height"])
        {
            ...
            [cloudAmend transformHeight:[self.etFirstOutlet.text intValue]];
        ...
        else if([self.lbfirstOutlet.text isEqualToString:@"Rotate"])
        {
            ...
            [cloudAmend rotate:[self.etFirstOutlet.text intValue]];
        ...
        else if([self.lbfirstOutlet.text isEqualToString:@"Quality"])
        {
            ...
            [cloudAmend quality:[self.etFirstOutlet.text intValue]];
        ...
        else if([self.lbfirstOutlet.text isEqualToString:@"Brightness"])
        {
            ...
            [cloudAmend brightness:[self.etFirstOutlet.text intValue]];
            
        }
        else if([self.lbfirstOutlet.text isEqualToString:@"Contrast"])
        {
            
            [cloudAmend contrast:[self.etFirstOutlet.text intValue]];
        ...
        {
            [cloudAmend crop:[self.etFirstOutlet.text intValue]];
        ...
        if([rowValue isEqualToString: @"Set image size - Width & Height"])
        {
            ...
            [cloudAmend transform:[self.etFirstOutlet.text intValue] andHeight:[self.etSecondOutlet.text intValue]];
        ...
        else if([rowValue isEqualToString: @"Fit Image - Fit XY"])
        {
            ...
            [cloudAmend transform:[self.etFirstOutlet.text intValue]  andHeight:[self.etSecondOutlet.text intValue] andFit:FIT_XY];
        }
        else if([rowValue isEqualToString:@"Fit Image - Fit Width"])
        {
            ...
            [cloudAmend transform:[self.etFirstOutlet.text intValue]  andHeight:[self.etSecondOutlet.text intValue] andFit:FIT_WIDTH];
        }
        else if([rowValue isEqualToString: @"Fit Image - Fit Height"])
        {
            ...
            [cloudAmend transform:[self.etFirstOutlet.text intValue]  andHeight:[self.etSecondOutlet.text intValue] andFit:FIT_HEIGHT];
        }
        ...
        else if([rowValue isEqualToString :@"Fit Image - Fit Inside"])
        {
            ...
            [cloudAmend transform:[self.etFirstOutlet.text intValue]  andHeight:[self.etSecondOutlet.text intValue] andFit:FIT_INSIDE];
        }
        
        else if([rowValue isEqualToString :@"Fit Face"])
        {
            // tactLab.transform(Width: Int(self.textfield1.text!)!, Height: Int(self.textfield2.text!)!, Fit: UIFitState.FIT_INSIDE)
            [cloudAmend transformFitFace:[self.etFirstOutlet.text intValue]  andHeight:[self.etSecondOutlet.text intValue]];
        }
        //                     else if([rowValue isEqualToString:@"Fit Image - Fit Inside"])
        //            {
        //               // tactLab.transform(Width: Int(self.textfield1.text!)!, Height: Int(self.textfield2.text!)!, Fit: UIFitState.FIT_INSIDE)
        ...
        else if([rowValue isEqualToString :@"Align Image - Align Left" ])
        {
            ...
            [cloudAmend transform:[self.etFirstOutlet.text intValue]  andHeight:[self.etSecondOutlet.text intValue] FIT_HEIGHT_andAlign:H_ALIGN_LEFT];
        }
        else if([rowValue isEqualToString: @"Align Image - Align Right"])
        {
            ...
            [cloudAmend transform:[self.etFirstOutlet.text intValue]  andHeight:[self.etSecondOutlet.text intValue] FIT_HEIGHT_andAlign:H_ALIGN_RIGHT];
        }
        else if([rowValue isEqualToString: @"Align Image - Align Center"])
        {
            ...
            [cloudAmend transform:[self.etFirstOutlet.text intValue]  andHeight:[self.etSecondOutlet.text intValue] FIT_HEIGHT_andAlign:H_ALIGN_CENTER];
        }
        else if([rowValue isEqualToString: @"Align Image - Align Top"])
        {
            ...
            [cloudAmend transform:[self.etFirstOutlet.text intValue]  andHeight:[self.etSecondOutlet.text intValue] FIT_WIDTH_andAlign:W_ALIGN_TOP];
        }
        else if([rowValue isEqualToString: @"Align Image - Align Bottom"])
        {
            ...
            [cloudAmend transform:[self.etFirstOutlet.text intValue]  andHeight:[self.etSecondOutlet.text intValue] FIT_WIDTH_andAlign:W_ALIGN_BOTTOM];
        ...
        else if([rowValue isEqualToString: @"Brightness & Contrast"])
        {
            ...
            [cloudAmend brightness:[self.etFirstOutlet.text intValue]  andContrast:[self.etSecondOutlet.text intValue] ];
        }
    }
        ...
        {
              [cloudAmend insertImage:self.etFirstOutlet.text  andPositionX:[self.etSecondOutlet.text intValue] andPositionY:[self.etThirdOutlet.text intValue]];
...
//            [NSString stringWithFormat:@"%@",self.etFirstOutlet.text]
            ...
            [cloudAmend transform:[self.etSecondOutlet.text intValue] andHeight:[self.etThirdOutlet.text intValue] andFit:FIT_INSIDE andBackGroundColour:colorIndex];
        ...
        if([rowValue isEqualToString:@"Origin"])
        {
            ...
            self.ivProcessedImageOutlet.contentMode = UIViewContentModeLeft;
            self.ivProcessedImageOutlet.clipsToBounds = YES;
            [cloudAmend transform:[self.etFirstOutlet.text intValue] andHeight:[self.etSecondOutlet.text intValue] andOriginX:[self.etThirdOutlet.text intValue] andOriginY:[self.etFourthOutlet.text intValue]];
            self.ivProcessedImageOutlet.frame = CGRectMake(10, self.ivProcessedImageOutlet.frame.origin.y, [self.etFirstOutlet.text intValue], self.ivProcessedImageOutlet.frame.size.height);
        ...
        if([rowValue isEqualToString:@"Insert Text	,Text,XY,Size,Style"])
        {
            [cloudAmend insertText:self.etFirstOutlet.text andPositionX:[self.etSecondOutlet.text intValue] andPositionY:[self.etThirdOutlet.text intValue] andSize:[self.etFourthOutlet.text intValue] andStyle:styleIndex andColor:colorIndex];
    ...
    self.ivProcessedImageOutlet.imageneryURL = [NSURL URLWithString:[cloudAmend getImage:[[NSUserDefaults standardUserDefaults] objectForKey:@"imageId"]]];
    }else{
        
        self.ivProcessedImageOutlet.imageneryURL = [NSURL URLWithString:[cloudAmend getImageByURL:[[NSUserDefaults standardUserDefaults] objectForKey:@"imageId"]]];
        
    }
    //    self.ivResultImageView. = UIImage(data: data as Data)
    
    
    //    if let url = NSURL(string: tactLab.allValue as String) {
    //        if let data = NSData(contentsOf: url as URL) {
    //
    //            self.ivResultImageView.image = UIImage(data: data as Data)
    //        }
    //    }
    ...
    UIAlertAction *okAction = [UIAlertAction actionWithTitle:@"OK"
                                                     ...
                                                     handler:^(UIAlertAction *action) {
                                                         ...
                                                         if(url.length>1){
                                                             ...
                                                             //self.ivProcessedImageOutlet.imageneryURL=[NSURL URLWithString:url];
                                                         }else{
                                                             //[self.view ]
                                                         }
