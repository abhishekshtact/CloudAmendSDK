...
- (IBAction)btStartCloudAmend:(id)sender {
  ...
  //  [self performSegueWithIdentifier:@"cloudamendfeatures" sender:self];
    ...
    [self presentViewController:alert animated:YES completion:nil];
        ...
        [[[Amend getInstance] initWithDelegate:self andImage:self.ivPickerImage.image andReqCode:0 andAccessKey:@"e1932d95-a132-46e8-8600-4979bb50163d" andAccessSecret:@"f4ad04e7f67b54430ffb51dc257c765a"] executeWithBase64];
        }else{
        [[[Amend getInstance] initWithDelegate:self andImage:self.ivPickerImage.image andReqCode:0 andAccessKey:@"e1932d95-a132-46e8-8600-4979bb50163d" andAccessSecret:@"f4ad04e7f67b54430ffb51dc257c765a"] executeWithBase64:self.tfImageNameOutlet.text];
    ...
    UIAlertAction *okAction = [UIAlertAction actionWithTitle:@"OK"
                                                     ...
                                                     handler:^(UIAlertAction *action) {
                                                         ...
                                                         if(url.length>1){
                                                             ...
                                                             self.ivPickerImage.imageneryURL=[NSURL URLWithString:url];
